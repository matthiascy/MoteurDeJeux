...
public:
    ...
    void chargerEvent(std::string nomEvent,std::string pathFmod);//premier param�tre est le nom � mapper, le deuxi�me et le chemin que on peu copier de FMOD. Note : il faut charger la banque de strings (Master.strings.bank), sous n'importe quel nom.
